package com.mani.fileupload.http;
...
import com.mani.fileupload.R;
import com.mani.fileupload.app.FileUploadApplication;

public class EasySSLSocketFactory implements LayeredSocketFactory {

    private SSLContext sslcontext = null;
    private boolean isConnectingToGoinoutServer = true;
    ...
    private SSLContext getSSLContext() throws IOException {
        if (this.sslcontext == null) {
        	if(isConnectingToGoinoutServer) {
